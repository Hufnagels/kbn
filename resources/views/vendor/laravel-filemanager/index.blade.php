...
<body>
  <div class="container-fluid" id="wrapper">
    <div class="panel panel-primary hidden-xs" id="inline-lfm-header">
      ...
      <div class="col-sm-10 col-xs-12" id="main">
        <nav class="navbar navbar-default" id="nav">
          <div class="navbar-header">
            <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#nav-buttons" style="margin-right:70px;">
  ...
  <script>
  if(window.parent.document.getElementById('inline-lfm')) {
      var nb = window.document.getElementById('nav-buttons'),
          h = window.document.getElementById('inline-lfm-header');
          nb.style.marginRight = "70px";
  ...
  <script>
    $.fn.fab = function () {
      var menu = this;
      menu.addClass('mfb-component--tr mfb-zoomin').attr('data-mfb-toggle', 'hover');
