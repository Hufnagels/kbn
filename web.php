...
Route::post('/register', 'Auth\RegisterController@index')->name('register');
  ...
  Route::prefix('manage')->group(function(){
    ...
    // JOBS
    Route::get('/jobs', 'Manage\JobController@index')->name('jobs.list');
    Route::get('/jobs/{job}', 'Manage\JobController@view')->name('jobs.view');
    Route::post('/jobs/{job}', 'Manage\JobController@updateStatus')->name('jobs.update');
    Route::delete('/jobs/{job}', 'Manage\JobController@forcedestroy')->name('jobs.destroy');
